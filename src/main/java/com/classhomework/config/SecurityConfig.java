...
import com.classhomework.security.JwtAuthenticationFilter;
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http.csrf(csrf -> csrf.disable())
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/homeworks/teacher").hasRole("TEACHER")
                        .requestMatchers("/homeworks/student").hasRole("STUDENT")
